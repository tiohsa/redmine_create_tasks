...
Redmine::Plugin.register :redmine_create_tasks do
  ...
  project_module :redmine_create_tasks do
    permission :view_redmine_create_tasks, {
      redmine_create_tasks: [:index, :spa, :assets, :register_issues, :data],
      redmine_create_tasks_ai: [:settings, :update_settings, :extract, :defaults]
    }, :require => :member
  end

  menu :project_menu,
       :redmine_create_tasks,
       { controller: 'redmine_create_tasks', action: 'index' },
       :caption => :label_redmine_create_tasks,
       :param => :project_id,
       :permission => :view_redmine_create_tasks,
  ...
  settings default: {
    ...
    PROMPT
  }, partial: 'settings/redmine_create_tasks_settings'
end
